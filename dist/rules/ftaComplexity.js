...
exports.ftaComplexityNeedsImprovement = exports.ftaComplexityCouldBeBetter = void 0;
...
const complexityRuleConfig = {
    ...
    create(context, [options]) {
        ...
        const scoreMustBeAtOrBelow = "when-at-or-under" in options
...
exports.ftaComplexityCouldBeBetter = utils_1.ESLintUtils.RuleCreator((name) => `https://example.com/rule/${name}`)({
    ...complexityRuleConfig,
    name: "complexity-could-be-better",
    defaultOptions: [{ "when-above": 50, "when-at-or-under": 60 }],
});
exports.ftaComplexityNeedsImprovement = utils_1.ESLintUtils.RuleCreator((name) => `https://example.com/rule/${name}`)({
    ...complexityRuleConfig,
    name: "complexity-needs-improvement",
    defaultOptions: [{ "when-above": 60 }],
});
//# sourceMappingURL=ftaComplexity.js.map